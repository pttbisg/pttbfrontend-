    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                />
                <Row>
                    <Col className="d-flex flex-column flex-md-row justify-content-end invoice-header mb-1" md="7" sm="12">
                        <Button
                            disabled={isLoading}
                        ...
                        >
                            {isLoading ? <span>Getting Data...</span> : <React.Fragment>
                                <RefreshCcw size="15" />
                    ...
                    <Col className="invoice-wrapper" sm="12">
                        <Card className="invoice-page">
                            ...
                            {data && data.length > 0 ?
                                    ...
                                    columns={[
                                        {
                                            ...
                                            Cell: props => {
                                                ...
                                                return (
                                                    <div>
                                                        <div className="text-bold-600 text-left navbar-light pt-1 pb-1 px-1 mb-1">{rowData.masterSKU}</div>
                                                        <div className="">
                                                        ...
                                                        <div className="d-flex flex-column flex-md-row justify-content-end navbar-light pt-1 pb-1 px-1">
                                                            <div className="title text-bold-600 mx-5">Balance Stock Left</div>
                                                            <div className="title text-bold-600">{rowData.balance_stock_left}</div>
                                                        </div>
                                                    </div>
                                                )
                                            }
                                ...
                                /> : isLoading ? 'Getting Data' : 'No Data'}
                            </CardBody>
                        </Card>
                    </Col>
                </Row>
